...
import {  NewUI_CreateNewProject, NewUI_deleteproject, NewUI_HistoryValidation, NewUI_OpenProject, NewUI_toastMessageValidation } from "../support/utilities";


let projectURL;
let projectName="nobranch";
let branchVersion= Cypress.env("branchVersion");

describe.skip("validate_project_with_no_branch.",()=>{
